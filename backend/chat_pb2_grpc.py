...
class ChatServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UploadVideo = channel.unary_unary(
                '/chat.ChatService/UploadVideo',
                request_serializer=chat__pb2.VideoRequest.SerializeToString,
                response_deserializer=chat__pb2.VideoReply.FromString,
                _registered_method=True)
        self.GetHistory = channel.unary_unary(
                '/chat.ChatService/GetHistory',
                request_serializer=chat__pb2.Empty.SerializeToString,
                response_deserializer=chat__pb2.ChatHistory.FromString,
                _registered_method=True)
...
def add_ChatServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'UploadVideo': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=chat__pb2.VideoRequest.FromString,
                    response_serializer=chat__pb2.VideoReply.SerializeToString,
            ),
            'GetHistory': grpc.unary_unary_rpc_method_handler(
                    servicer.GetHistory,
                    request_deserializer=chat__pb2.Empty.FromString,
                    response_serializer=chat__pb2.ChatHistory.SerializeToString,
            ),
    }
...
class ChatService(object):
    ...
    def UploadVideo(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/chat.ChatService/UploadVideo',
            chat__pb2.VideoRequest.SerializeToString,
            chat__pb2.VideoReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetHistory(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            chat__pb2.ChatHistory.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
