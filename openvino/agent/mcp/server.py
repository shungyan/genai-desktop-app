...
def fetch_chat_history():
    ...
    if messages:
        ...
        return ("Chat history sucessfully fetched")
    else:
...
def summarize_chat_history():
    """
    Reads chat history from a text file and sends it to Ollama for summarization. 
    """
...
# -------------------------------------------------------------------------------------------------------------------------------------------------------------------------
OLLAMA_HOST = "http://localhost:5678"  # change if running on another host/IP
